...
def send_welcome(message):
    bot.reply_to(message, 'Send me any type of a file & I will send you the direct shorten link of it to get help join our Telegram Channel @WidoxLK Developer @WidoxAdmin ')    
