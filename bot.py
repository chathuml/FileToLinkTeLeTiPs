...
def send_welcome(message):
    bot.reply_to(message, 'Hello! I am a File To Link Bot created by @WidoxLK .Send me any file under 2GB (Video, Audio, Photo, Document)👇🏻')

@bot.message_handler(commands=['help'])
def send_welcome(message):
    bot.reply_to(message, 'Send me any type of a file & I will send you the shorten link of it within 1 second Join @Widoxlk Channel and Discussion')    
